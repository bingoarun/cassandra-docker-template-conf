...
COPY apply-template.py /apply-template.py 
...
RUN mkdir -p /var/lib/cassandra2  \
        && chown -R cassandra:cassandra /var/lib/cassandra2  \
        && chmod 777 /var/lib/cassandra2 



VOLUME /var/lib/cassandra /var/lib/cassandra2
